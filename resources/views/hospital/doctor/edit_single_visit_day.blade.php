            ...
            <div class="col-md-9">
                ...
                <div class="card" style="min-height: 560px">
                    ...
                    <div class="card-body">
                        ...
                        <form id="assignForm" class="" method="post"
                            action="{{ route('hospital.editVisitDayTimeAction') }}">
                            @csrf
                            <!-- Hidden Item -->
                            <input name="hospital_id" type="hidden" value="{{$hospital_id}}" hidden />
                            @error('hospital_id')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror

                            <input name="doctor_id" type="hidden" value="{{$doctor_id}}" hidden />
                            @error('doctor_id')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror

                            <input name="bartime_id" type="hidden" hidden value="{{ $bartime_object->id }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Day</label>
                                      <input name="bartime" type="text" class="form-control" value="{{ $bartime }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="visitType" name="visit_type" class="form-control select2">
                                            ...
                                            <option
                                            @if($bartime_object->shift_type == "m")
                                                selected
                                            @endif   
                                                value="m">
                                                Morning
                                            ...
                                            <option 
                                              @if($bartime_object->shift_type == "e")
                                                selected
                                            @endif   
                                            value="e">Evening </option>
                                            <option 
                                              @if($bartime_object->shift_type == "b")
                                                selected
                                            @endif   
                                            value="b">Morning and Evening </option>
                                            <option 
                                              @if($bartime_object->shift_type == "d")
                                                selected
                                            @endif   
                                            value="d">Full Day</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        function shiftChanger(visitType) {
            if (visitType == "m") {
        ...
        var init_shift_val = $("#visitType").val();
        shiftChanger(init_shift_val);

        //on change work
        var visitType = "";
        $("#visitType").on("change", function () {
            visitType = $(this).val();
            shiftChanger(visitType);    
        });
        //on change work end
    ...
    <div class="row morning">\
        <div class="col-md-6">\
            <div class="form-group">\
                ...
                <input name="m_start_time" type="time" class="form-control" value="{{ $bartime_object->start_time }}" />\
            </div>\
        </div>\
        <div class="col-md-6">\
            <div class="form-group">\
                <label for="">Visit end hour</label>\
                <input name="m_end_time" type="time" class="form-control" value="{{ $bartime_object->end_time }}" />\
            </div>\
        </div>\
    </div>\
</div>';
    ...
    <div class="row evening">\
        <div class="col-md-6">\
            <div class="form-group">\
                ...
                <input name="e_start_time" type="time" class="form-control" value="{{ $bartime_object->evening_start_time }}" />\
            </div>\
        </div>\
        <div class="col-md-6">\
            <div class="form-group">\
                <label for=""> Evening Visit end hour</label>\
                <input name="e_end_time" type="time" class="form-control" value="{{ $bartime_object->evening_end_time }}" />\
            </div>\
        </div>\
    </div>\
</div>';
    ...
    <div class="row Fullday">\
        <div class="col-md-6">\
            <div class="form-group">\
                ...
                <input name="d_start_time" type="time" class="form-control" value="{{ $bartime_object->day_start_time }}" />\
            </div>\
        </div>\
        <div class="col-md-6">\
            <div class="form-group">\
                <label for=""> Fullday Visit end hour</label>\
                <input name="d_end_time" type="time" class="form-control" value="{{ $bartime_object->day_end_time }}" />\
            </div>\
        </div>\
    </div>\
</div>';
