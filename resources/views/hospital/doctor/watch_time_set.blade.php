            ...
            <div class="col-md-9">
                ...
                <div class="card" style="min-height: 560px">
                    <div class="card-header font-weight-bold">
                        <h4 class="card-title">set min</h4>
                    </div>
                    <div class="card-body">
                        <form id="assignForm" class="" method="post" action="{{ route('hospital.doctorWatchTimeAction') }}">
                            @csrf
                            <!-- Hidden Item -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="watch_time" class="form-control" placeholder="set min, e.g: 5 or 20" >
                                    </div>
                                </div>
                            </div>
