    ...
    @if (session('message'))
        <div class="row">
            <div class="col-md-6 offset-md-6">
                ...
                bg-success text-white alert-dismissible fade show" role="alert">
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-dark  float-end" href="{{route('admin.hospital.create') }}">
                            Add New Hospital
                        </a>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn icon btn-outline-danger"
                                                    href="{{route('admin.hospital.edit', $hospital->id)}}"
                                                    data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fas fa fa-edit"></i>
                                                    <!-- <i class="far fa-edit"></i> -->
                                                </a>
                                                <a class="btn icon btn-outline-info"
                                                    href="{{route('admin.assign.doctor',$hospital->id) }}"
                                                    data-toggle="tooltip" data-placement="top" title="Assign Doctor">
                                                    <i class="fas fa fa-id-card-alt"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        @endforeach
